          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<SiRedux />} name={"Redux"} value={85} />
                <ProgressBar logo={<SiVuedotjs />} name={"Vue Js"} value={88} />
                <ProgressBar
                  logo={<SiBootstrap />}
                  name={"Bootstrap"}
                  value={88}
                ...
                <ProgressBar
                  ...
                  value={80}
                />
                <ProgressBar logo={<SiRedis />} name={"Redis"} value={80} />
                <ProgressBar logo={<SiDocker />} name={"Docker"} value={80} />
              </div>
            </div>
          </div>
          {/* right box */}
